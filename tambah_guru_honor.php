...
$sqljabatan = "SELECT * FROM jabatan_honor ORDER BY kode_jabatan DESC";
...
<body>
  ...
  <div id="login-page">
    <div class="container">
      <form class="form-login" action="includes/tambah_guru_honor.inc.php" method="POST">
        <h2 class="form-login-heading">Tambahkan Data Guru</h2>
        <div class="login-wrap">
                <input type="text" name="nuptik" class="form-control" placeholder="NUPTIK" autofocus>
                <br>
                ...
                <br>
                <input type="number" name="tunjangan" class="form-control" placeholder="Tunjangan" autofocus>
                <br>
                 <input type="number" name="potongan" class="form-control" placeholder="Potongan" autofocus>
                <br>
