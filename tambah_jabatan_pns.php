...
<body>
  ...
  <div id="login-page">
    <div class="container">
      <form class="form-login" action="includes/tambah_jabatan_pns.inc.php" method="POST">
        <h2 class="form-login-heading">Tambahkan Jabatan</h2>
            <div class="login-wrap">
                ...
                <br>
                <input type="number" name="tj_jabatan" class="form-control" placeholder="Tunjangan Jabatan" autofocus>
                <br>
