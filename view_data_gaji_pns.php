...
<body>
      ...
      <section class="wrapper">
        <!-- mulai coding tahun bulan-->
         ...
         <div class="alert alert-info">
           ...
           <form action="view_data_gaji_pns.php" method="POST">
             <select name="bulan">
  ...
  if ((isset($_POST['bulan']))&&(isset($_POST['tahun']))) {
   $bulan=$_POST['bulan'];
   $tahun=$_POST['tahun'];
  $sql = "select * from guru_pns,gaji_pns,jabatan_pns,golongan_pns,periode_gaji WHERE guru_pns.nip=gaji_pns.nip and jabatan_pns.kode_jabatan=guru_pns.kode_jabatan and golongan_pns.kode_golongan=guru_pns.kode_golongan and gaji_pns.id_bulan=periode_gaji.id AND periode_gaji.bulan=$bulan AND periode_gaji.tahun=$tahun";
  ...
  echo ' <thead>
    ...
    if (mysqli_num_rows($result) > 0) {  
     echo "<tr>
            <td colspan='7' text-align='center'><a href='view_data_gaji_pns.php'></a></td></tr> ";
    }else {
