...
<body>
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
           ...
           <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active"><a href="data_guru_pns.php">Data/Edit Guru</a></li>
  ...
  $sql = "SELECT * FROM guru_pns";
  $result = mysqli_query($conn, $sql);
  echo '<div class="row mb">';
  echo "<div class='content-panel'>";
  echo '<div class="adv-table">';
  echo '<h4><i class="fa fa-angle-right"></i> Edit Data Guru</h4>';
  echo '<hr>';
  ...
  echo ' <thead>
    ...
    if (mysqli_num_rows($result) > 0) {
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td><a href='edit_guru_pns.php?nip=".$row['nip']."'  class='btn btn-info'>
      <span class='glyphicon glyphicon-pencil' aria-hidden='true'></span>Edit</a> 
      <a href='includes/delete_guru_pns.inc.php?nip=".$row['nip']."'class='btn btn-danger' onclick='return confirm(`Anda yakin mau menghapus data ?`);'>
