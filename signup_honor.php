...
<body>
  ...
  <div id="login-page">
    <div class="container">
      <form class="form-login" action="includes/signup_honor.inc.php" method="POST">
        ...
        <div class="login-wrap">
                ...
                <br>
                <input type="password" name="confirmpwd" class="form-control" placeholder="confirm password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                <!--<input type="password" name="pwd2" class="form-control" placeholder="Password">-->
                <button class="btn btn-theme btn-block" type="submit" name="submit">signup</button>
                </form>
                <a href="index.php">home</a><br>
                <a href="login_honor.php">Saya Sudah Punya Akun</a>
                <hr>  
