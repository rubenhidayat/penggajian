        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="mt">
           ...
           <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active"><a href="data_guru_honor.php">Data/Edit Guru</a></li>
  ...
  echo ' <thead>
    ...
    if (mysqli_num_rows($result) > 0) {
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td><a href='edit_guru_honor.php?id_guru=".$row['id_guru']."'  class='btn btn-info'>
      <span class='glyphicon glyphicon-pencil' aria-hidden='true'></span>Edit</a> 
      <a href='includes/delete_guru_honor.inc.php?id_guru=".$row['id_guru']."'class='btn btn-danger' onclick='return confirm(`Anda yakin mau menghapus data ?`);'>
