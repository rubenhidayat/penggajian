...
$sql = "SELECT * FROM jabatan_pns WHERE kode_jabatan='$kode_jabatan'";
...
<body>
  ...
  <div id="login-page">
    <div class="container">
      <form class="form-login" action="includes/edit_jabatan_pns.inc.php" method="POST">
        <h2 class="form-login-heading">Tambahkan Jabatan</h2>
            <div class="login-wrap">
                ...
                <br>
                <input type="number" name="tj_jabatan" class="form-control" value="<?php echo"".$row['tj_jabatan']?>"  placeholder="Tunjangan Jabatan" autofocus>
                <br>
