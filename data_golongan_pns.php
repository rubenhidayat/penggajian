...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="admin_pns.php" class="logo"><b>PENGGAJIAN GURU  <span>SD NEGERI 85 PALEMBANG</span></b></a>
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active"><a href="data_golongan_pns.php">Data/Edit Golongan</a></li>
  ...
  $sql = "SELECT * FROM golongan_pns";
  $result = mysqli_query($conn, $sql);
  echo '<div class="row mb">';
  echo "<div class='content-panel'>";
  echo '<div class="adv-table">';
  echo '<h4><i class="fa fa-angle-right"></i> Edit Data Golongan</h4>';
  echo '<hr>';
  ...
  echo ' <thead>
    ...
    if (mysqli_num_rows($result) > 0) {
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<td>'.$row["tj_suami_istri"].'</td>';
        echo '<td>'.$row["tj_anak"].'</td>';
        echo '<td>'.$row["tj_fungsional"].'</td>';
        echo '<td>'.$row["pot_tp"].'</td>';

        
        echo "<td><a href='edit_golongan_pns.php?kode_golongan=".$row['kode_golongan']."'  class='btn btn-info'>
      <span class='glyphicon glyphicon-pencil' aria-hidden='true'></span>Edit</a> 
      <a href='includes/delete_golongan_pns.inc.php?kode_golongan=".$row['kode_golongan']."'class='btn btn-danger' onclick='return confirm(`Anda yakin mau menghapus data ?`);'>
